...
const Clock = () => {
    // const { sessionLength, setSessionLength, setIsSessionTime, setIsBreakTime } = useStateContext()
    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            ...
            <div>
                <button className='w-auto bg-slate-600 rounded-xl py-3 px-5 text-2xl leading-9'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="bg-transparent text-gray-200 border-0 inline-block w-16 h-16" viewBox="0 0 20 20" fill="currentColor">
